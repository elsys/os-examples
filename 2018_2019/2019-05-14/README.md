...
- Най-десният - Първи LED
- Следващият отдясно наляво - Втори LED
- Следващият (трети) - Трети LED
- Следващият - Четвърти LED

Съответно бихме имали:
 - 0000000000000001 - Свети първият
 - 0000000000000010 - Свети вторият
 - 0000000000000100 - Свети третият
 - 0000000000001000 - Свети четвъртият
